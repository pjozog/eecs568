...
public final class point3d_list_collection_t implements lcm.lcm.LCMEncodable
{
    ...
    public int nlists;
    public vs.point3d_list_t point_lists[];
    ...
    public static final short LINE_STRIP = (short) 2;
    public static final short LINE_LOOP = (short) 3;
    public static final short LINES = (short) 4;
    public static final short TRIANGLE_STRIP = (short) 5;
    public static final short TRIANGLE_FAN = (short) 6;
    public static final short TRIANGLES = (short) 7;
    public static final short QUAD_STRIP = (short) 8;
    public static final short QUADS = (short) 9;
    public static final short POLYGON = (short) 10;
    ...
    {
        if (classes.contains(vs.point3d_list_collection_t.class))
            return 0L;
 
        classes.add(vs.point3d_list_collection_t.class);
        long hash = LCM_FINGERPRINT_BASE
             + vs.point3d_list_t._hashRecursive(classes)
            ;
    ...
    public static vs.point3d_list_collection_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        vs.point3d_list_collection_t o = new vs.point3d_list_collection_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.point_lists = new vs.point3d_list_t[(int) nlists];
        for (int a = 0; a < this.nlists; a++) {
            this.point_lists[a] = vs.point3d_list_t._decodeRecursiveFactory(ins);
        }
 
    }
 
    public vs.point3d_list_collection_t copy()
    {
        vs.point3d_list_collection_t outobj = new vs.point3d_list_collection_t();
        outobj.id = this.id;
        ...
        outobj.point_lists = new vs.point3d_list_t[(int) nlists];
        for (int a = 0; a < this.nlists; a++) {
