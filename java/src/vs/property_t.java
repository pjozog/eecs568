...
public final class property_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(vs.property_t.class))
            return 0L;
 
        classes.add(vs.property_t.class);
    ...
    public static vs.property_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        vs.property_t o = new vs.property_t();
    ...
    public vs.property_t copy()
    {
        vs.property_t outobj = new vs.property_t();
