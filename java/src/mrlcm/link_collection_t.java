...
public final class link_collection_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mrlcm.link_collection_t.class))
            return 0L;
 
        classes.add(mrlcm.link_collection_t.class);
        long hash = LCM_FINGERPRINT_BASE
             + mrlcm.link_t._hashRecursive(classes)
            ;
    ...
    public static mrlcm.link_collection_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mrlcm.link_collection_t o = new mrlcm.link_collection_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.links = new mrlcm.link_t[(int) nlinks];
        for (int a = 0; a < this.nlinks; a++) {
            this.links[a] = mrlcm.link_t._decodeRecursiveFactory(ins);
        }
 
    }
 
    public mrlcm.link_collection_t copy()
    {
        mrlcm.link_collection_t outobj = new mrlcm.link_collection_t();
        outobj.id = this.id;
        ...
        outobj.links = new mrlcm.link_t[(int) nlinks];
        for (int a = 0; a < this.nlinks; a++) {
