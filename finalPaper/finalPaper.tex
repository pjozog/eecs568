...
% Section~\ref{sub:quadrotor}, presenting us a 6-\ac{DOF} platform with which to work.
...
matrices inherent in our problem.  In Section~\ref{sec:incrementalsmoothingandmapping}, we
