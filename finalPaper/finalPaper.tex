...
\begin{figure*}[!t]
  \begin{center}
    \subfigure[Manhattan dataset from~\cite{olson2006fast}] {
      \includegraphics[width=2.5in]{images/manhattanOlson}
  ...
  \caption{\subref{fig:manhattanResult} shows the final result of our SLAM back-end on the
    ...
    \subref{fig:manhattanChi2} is nearly identical to that of iSAM's.}
  \label{fig:manhattan}
\end{figure*}
...
been built.  The back-end would find an optimal graph, and display it realtime.  Watching
this unfold in 3D \texttt{Vis} scene proved to be a creative learning tool for the student
who may not be familiar with least-squares SLAM.
...
of the data association problem, and could even be used with front-end that have unknown
data association.
