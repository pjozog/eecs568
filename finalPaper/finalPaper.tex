...
large number of observations and states that must be reconciled. Least-squares approaches
...
and play back the messages sent between processes. This tool allows us to keep a record of
...
% \begin{figure*}[!t]
%   \begin{center}
%     \subfigure[Final map of Manhattan dataset from~\cite{olson2006fast}] {
...
%     \subfigure[Final map of Victoria Park dataset from~\cite{Guivant00autonomousnavigation}] {
...
%     \subref{fig:manhattanChi2} and \subref{fig:victoriaChi2}, iSAM occasionally suffers
...
\begin{figure*}[!t]
  \begin{center}
    \subfigure[Final map of Manhattan dataset from~\cite{olson2006fast}] {
      ...
      \label{fig:manhattanResult}} \hspace{1cm}
    \subfigure[Manhattan World normalized $\chi^2$ error] {
      \includegraphics[width=2.4in]{images/chi2}
      \label{fig:manhattanChi2}}\\
    \subfigure[Final map of Victoria Park dataset from~\cite{Guivant00autonomousnavigation}] {
      \includegraphics[width=3.0in]{images/victoriaPark}
      \label{fig:victoriaResult}} \hspace{1cm}
    \subfigure[Victoria Park normalized $\chi^2$ error] {\vspace{-5cm}
      \includegraphics[width=2.4in]{images/chi2vic}
      \label{fig:victoriaChi2}}
  \end{center}
  \caption{The final maps and normalized $\chi^2$ values for each step from our SLAM
    implementation on two datasets.  As evidenced by the peaks in
...
with standard specifications in real time.
...
user can induce residuals for certain poses by physically moving a tag once the map has
...
\bibitem{dellaert2005square}
F.~Dellaert and M.~Kaess, ``Square root sam,'' in \emph{Proc. of robotics:
  science and systems (RSS)}, 2005, pp. 177--184.

\bibitem{Kaess08tro}
M.~Kaess, A.~Ranganathan, and F.~Dellaert, ``{iSAM}: Incremental smoothing and
  mapping,'' \emph{IEEE Trans. on Robotics, TRO}, vol.~24, no.~6, pp.
  1365--1378, Dec 2008.

\bibitem{achtelik2008autonomous}
M.~Achtelik, A.~Bachrach, R.~He, S.~Prentice, and N.~Roy, ``Autonomous
  navigation and exploration of a quadrotor helicopter in gps-denied indoor
  environments,'' in \emph{Robotics: Science and Systems Conference}, 2008.

\bibitem{ghadiok2011autonomous}
V.~Ghadiok, J.~Goldin, and W.~Ren, ``Autonomous indoor aerial gripping using a
  quadrotor,'' in \emph{Intelligent Robots and Systems (IROS), 2011 IEEE/RSJ
  International Conference on}.\hskip 1em plus 0.5em minus 0.4em\relax IEEE,
  2011, pp. 4645--4651.

\bibitem{huang2010}
A.~Huang, E.~Olson, and D.~Moore, ``{LCM}: Lightweight communications and
  marshalling,'' in \emph{Proceedings of the {IEEE/RSJ} International
  Conference on Intelligent Robots and Systems {(IROS)}}, October 2010.

\bibitem{thrun2005probabilistic}
S.~Thrun, W.~Burgard, and D.~Fox, \emph{Probabilistic Robotics}.\hskip 1em plus
  0.5em minus 0.4em\relax MIT Press, 2005.
\\
\bibitem{golub1996matrix}
G.~Golub and C.~Van~Loan, \emph{Matrix computations}.\hskip 1em plus 0.5em
  minus 0.4em\relax Johns Hopkins Univ Pr, 1996, vol.~3.

\bibitem{davis2004column}
T.~Davis, J.~Gilbert, S.~Larimore, and E.~Ng, ``A column approximate minimum
  degree ordering algorithm,'' \emph{ACM Transactions on Mathematical Software
  (TOMS)}, vol.~30, no.~3, pp. 353--376, 2004.

\bibitem{rsmith-1990a}
R.~Smith, M.~Self, and P.~Cheeseman, ``Estimating uncertain spatial
  relationships in robotics,'' in \emph{Autonomous Robot Vehicles}, I.~Cox and
  G.~Wilfong, Eds.\hskip 1em plus 0.5em minus 0.4em\relax Springer-Verlag,
  1990, pp. 167--193.

\bibitem{reustice-phdthesis}
R.~M. Eustice, ``Large-area visually augmented navigation for autonomous
  underwater vehicles,'' Ph.D. dissertation, I-MIT/WHOI, Jun. 2005.

\bibitem{olson2011tags}
...
\bibitem{ardronedevguide}
S.~Piskorski, N.~Brulez, and P.~Eline, \emph{{AR.Drone Developer Guide}},
  Parrot, May 2011, sdk 1.7.

\bibitem{olson2006fast}
E.~Olson, J.~Leonard, and S.~Teller, ``Fast iterative alignment of pose graphs
  with poor initial estimates,'' in \emph{Robotics and Automation, 2006. ICRA
  2006. Proceedings 2006 IEEE International Conference on}.\hskip 1em plus
  0.5em minus 0.4em\relax Ieee, 2006, pp. 2262--2269.

\bibitem{Guivant00autonomousnavigation}
J.~Guivant, E.~Nebot, and S.~Baiker, ``Autonomous navigation and map building
  using laser range sensors in outdoor applications,'' \emph{Journal of Robotic
  Systems}, vol.~17, pp. 3817--3822, 2000.
