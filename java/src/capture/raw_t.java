...
public final class raw_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(capture.raw_t.class))
            return 0L;
 
        classes.add(capture.raw_t.class);
    ...
    public static capture.raw_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        capture.raw_t o = new capture.raw_t();
    ...
    public capture.raw_t copy()
    {
        capture.raw_t outobj = new capture.raw_t();
