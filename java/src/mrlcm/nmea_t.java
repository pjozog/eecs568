...
public final class nmea_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mrlcm.nmea_t.class))
            return 0L;
 
        classes.add(mrlcm.nmea_t.class);
    ...
    public static mrlcm.nmea_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mrlcm.nmea_t o = new mrlcm.nmea_t();
    ...
    public mrlcm.nmea_t copy()
    {
        mrlcm.nmea_t outobj = new mrlcm.nmea_t();
