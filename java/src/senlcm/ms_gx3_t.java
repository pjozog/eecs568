...
public final class ms_gx3_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    public long bitmask;
    ...
    public static final long LCM_FINGERPRINT_BASE = 0xbd61abbb1db6d0adL;
    ...
    public static final short STAB_MAGFIELD = (short) 8;
    public static final short STAB_ACCEL = (short) 16;
    public static final short STAB_ANGRATE = (short) 32;
    public static final short STAB_EULER = (short) 64;
    public static final short STAB_M = (short) 128;
    public static final short STAB_Q = (short) 256;
    public static final short TEMPERATURE = (short) 512;
    ...
    {
        if (classes.contains(senlcm.ms_gx3_t.class))
            return 0L;
 
        classes.add(senlcm.ms_gx3_t.class);
    ...
    public ms_gx3_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public ms_gx3_t(DataInput ins) throws IOException
    {
    ...
    public static senlcm.ms_gx3_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        senlcm.ms_gx3_t o = new senlcm.ms_gx3_t();
    ...
    public senlcm.ms_gx3_t copy()
    {
        senlcm.ms_gx3_t outobj = new senlcm.ms_gx3_t();
