...
public class Radar
{
	...
	double mean [] = new double[]{rMean, thetaMean};
	double cov[][] = new double[2][2];

	//Starting with r, ending with theta, assuming independent
	...
	ArrayUtil.print2dArray(jac);
	System.out.println("jact");
	ArrayUtil.print2dArray(jacT);
	...
	ArrayUtil.print2dArray(projCovXY);
	ArrayUtil.print1dArray(projMeanXY);
