...
import team.common.MultiGaussian;
        ...
        pg.addListener(new ParameterListener() {
                ...
                { 
                    ...
                    if (name.equals("sigRange") || 
                        ...
                        vb.addBack(new VzLines(vdCont, vcdCont, 4, VzLines.TYPE.LINE_LOOP));
                        vb.addBack(new VzLines(vdProj, vcdProj, 4, VzLines.TYPE.LINE_LOOP));
                        vb.swap();
