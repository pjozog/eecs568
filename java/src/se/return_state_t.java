...
public final class return_state_t implements lcm.lcm.LCMEncodable
{
    public long utime;
    public int n;
    public se.pose_t poses[];
    public int k;
    ...
    {
        if (classes.contains(se.return_state_t.class))
            return 0L;
 
        classes.add(se.return_state_t.class);
        long hash = LCM_FINGERPRINT_BASE
             + se.pose_t._hashRecursive(classes)
            ;
    ...
    public return_state_t(byte[] data) throws IOException
    {
        this(new LCMDataInputStream(data));
    }
 
    public return_state_t(DataInput ins) throws IOException
    {
    ...
    public static se.return_state_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        se.return_state_t o = new se.return_state_t();
    ...
    public void _decodeRecursive(DataInput ins) throws IOException
    {
        ...
        this.poses = new se.pose_t[(int) n];
        for (int a = 0; a < this.n; a++) {
            this.poses[a] = se.pose_t._decodeRecursiveFactory(ins);
        }
    ...
    public se.return_state_t copy()
    {
        se.return_state_t outobj = new se.return_state_t();
        outobj.utime = this.utime;
 
        outobj.n = this.n;
 
        outobj.poses = new se.pose_t[(int) n];
        for (int a = 0; a < this.n; a++) {
