...
public class OldSimulator implements Runnable
{
    ...
    public OldSimulator(Config _config)
    {
        config = _config;
    ...
    public void drawTruth(ArrayList<landmark_t> clean_dets, ArrayList<landmark_t> noisy_dets)
    {
        ...
        // Draw true Trajectory
        {
            ...
            vb.addBack(new VzLines(new VisVertexData(truthTrajectory),
        ...
        // Draw the landmarks
        {
            ...
            for (double l[] : landmarks) {
                vb.addBack(new VisChain(LinAlg.translate(l[0],l[1],0),
                                        ...
                                        new VzLines(vdat, new VisConstantColor(Color.green),
    ...
    public static void main(String args[]) throws java.io.IOException
    {
        ...
        OldSimulator sim  = new OldSimulator(new ConfigFile(gopt.getString("config")));
