...
public class VisDemo
{
    ...
    public static void main(String args[])
    {
        ...
        pg.addListener(new ParameterListener(){
                public void parameterChanged(ParameterGUI pg, String name)
                {
                    if (name.equals("startx") || name.equals("starty")) {
                        ...
                        VzPoints vp = new VzPoints(vd, vcol, 15);
                    ...
                    if (name.equals("sig")) {
                        ...
                        vb.addBack(new VzPoints(vd,vcd, 4));
                        // vb.addBack(new VzLines(vd,vcd, 4, VzLines.TYPE.LINES));
                        vb.swap();
                    }
                }
            });
        ...
        while (true) {
            ...
            VzLines vline = new VzLines(new VisVertexData(points),
                                          new VisConstantColor(Color.blue), 3, VzLines.TYPE.LINE_LOOP);
