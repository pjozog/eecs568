...
public final class link_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(mrlcm.link_t.class))
            return 0L;
 
        classes.add(mrlcm.link_t.class);
    ...
    public static mrlcm.link_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        mrlcm.link_t o = new mrlcm.link_t();
    ...
    public mrlcm.link_t copy()
    {
        mrlcm.link_t outobj = new mrlcm.link_t();
        outobj.id = this.id;
