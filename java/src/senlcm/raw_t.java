...
public final class raw_t implements lcm.lcm.LCMEncodable
{
    ...
    {
        if (classes.contains(senlcm.raw_t.class))
            return 0L;
 
        classes.add(senlcm.raw_t.class);
    ...
    public static senlcm.raw_t _decodeRecursiveFactory(DataInput ins) throws IOException
    {
        senlcm.raw_t o = new senlcm.raw_t();
    ...
    public senlcm.raw_t copy()
    {
        senlcm.raw_t outobj = new senlcm.raw_t();
