...
public class PartOneListener implements OldSimulator.Listener
{
    ...
    private ArrayList<OldSimulator.odometry_t> allTicks       = new ArrayList<OldSimulator.odometry_t>();
    ...
    **/
    private int getLandmarkId(Node currentPos, OldSimulator.landmark_t det, OldSimulator.odometry_t odom, Node lastOdNode){
    ...
    public void drawDummy(ArrayList<OldSimulator.landmark_t> landmarks)
    {
        ...
        // Draw our least squares best guess of the landmark positions
        {
            ...
            vb.addBack(new VzPoints(new VisVertexData(estimatedLandmarkPositions),
